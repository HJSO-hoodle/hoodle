...
export function getConstantVowel(kor) {
    ...
    const cvList = {
        f : ['ㄱ', ['ㄱ','ㄱ'], 'ㄴ', 'ㄷ', ['ㄷ','ㄷ'], 'ㄹ', 'ㅁ',
            'ㅂ', ['ㅂ','ㅂ'], 'ㅅ', ['ㅅ','ㅅ'], 'ㅇ', 'ㅈ', ['ㅈ','ㅈ'],
            'ㅊ', 'ㅋ', 'ㅌ', 'ㅍ', 'ㅎ'],
        s : ['ㅏ', ['ㅏ','ㅣ'], 'ㅑ', ['ㅑ','ㅣ'], 'ㅓ', ['ㅓ','ㅣ'], 'ㅕ',
            ['ㅕ','ㅣ'], 'ㅗ', ['ㅗ','ㅏ'], ['ㅗ','ㅏ','ㅣ'], ['ㅗ','ㅣ'], 'ㅛ', 'ㅜ',
            ['ㅜ','ㅓ'], ['ㅜ','ㅓ','ㅣ'], ['ㅜ','ㅣ'], 'ㅠ', 'ㅡ', ['ㅡ','ㅣ'], 'ㅣ'],
        t : ['', 'ㄱ', ['ㄱ','ㄱ'], ['ㄱ','ㅅ'], 'ㄴ', ['ㄴ','ㅈ'], ['ㄴ','ㅎ'],
            'ㄷ', 'ㄹ', ['ㄹ','ㄱ'], ['ㄹ','ㅁ'], ['ㄹ','ㅂ'], ['ㄹ','ㅅ'], ['ㄹ','ㅌ'],
            ['ㄹ','ㅍ'], ['ㄹ','ㅎ'], 'ㅁ', 'ㅂ', ['ㅂ','ㅅ'], 'ㅅ', ['ㅅ','ㅅ'],
            'ㅇ', 'ㅈ', 'ㅊ', 'ㅋ', 'ㅌ', 'ㅍ', 'ㅎ'],
        j : ['ㄱ', ['ㄱ','ㄱ'], ['ㄱ','ㅅ'], 'ㄴ', ['ㄴ','ㅈ'], ['ㄴ','ㅎ'],
            'ㄷ', ['ㄷ','ㄷ'], 'ㄹ', ['ㄹ','ㄱ'], ['ㄹ','ㅁ'], ['ㄹ','ㅂ'], ['ㄹ','ㅅ'], ['ㄹ','ㅌ'],
            ['ㄹ','ㅍ'], ['ㄹ','ㅎ'], 'ㅁ', 'ㅂ', ['ㅂ','ㅂ'], ['ㅂ','ㅅ'], 'ㅅ', ['ㅅ','ㅅ'],
            'ㅇ', 'ㅈ', ['ㅈ','ㅈ'], 'ㅊ', 'ㅋ', 'ㅌ', 'ㅍ', 'ㅎ'],
    };
 ...
 * 위의 getConstantVowel 함수를 활용하려고 했는데,
 * 한글로 입력시 ㅇ ㅗ ㅐ 라고 입력하면 ㅇ ㅗ ㅇ ㅗ ㅐ라고
 * 'ㅐ'를 입력할때 이전에 입력한 값이 남아있는 버그가 존재해서
 * 우선 e.code 값을 받아서 변환하기로 함..
*/
export function changeCodeOfHangle(code) {
    const hangle = {
        KeyQ: "ㅂ", KeyW: "ㅈ", KeyE: "ㄷ", KeyR: "ㄱ", KeyT: "ㅅ",
        KeyY: "ㅛ", KeyU: "ㅕ", KeyI: "ㅑ", KeyA: "ㅁ", KeyS: "ㄴ",
        KeyD: "ㅇ", KeyF: "ㄹ", KeyG: "ㅎ", KeyH: "ㅗ", KeyJ: "ㅓ",
        KeyK: "ㅏ", KeyL: "ㅣ", KeyZ: "ㅋ", KeyX: "ㅌ", KeyC: "ㅊ",
        KeyV: "ㅍ", KeyB: "ㅠ", KeyN: "ㅜ", KeyM: "ㅡ",
    }
